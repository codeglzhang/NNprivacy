package ai.protect.privacy.network.lenet5;

import ai.protect.privacy.network.LAYERTYPE;
import ai.protect.privacy.network.Layer;
import ai.protect.privacy.network.LayerSimpleFactory;
import ai.protect.privacy.network.Network;
import ai.protect.privacy.network.layercomputer.parameters.Cov2dParameter;
import ai.protect.privacy.network.node.*;
...
public class SimplLeNet5 {
    public Network network = new Network();

    public void init(){
        LayerSimpleFactory factory = new LayerSimpleFactory();
        Layer cov1 = factory.createLayer(LAYERTYPE.CONVOLUTION,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\cov1",new SimpleNode());
        Layer pool1 = factory.createLayer(LAYERTYPE.POOL,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\pool1",new MaxNode(new ReLu(),new SimpleOptions()));
        Layer cov2 = factory.createLayer(LAYERTYPE.CONVOLUTION,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\cov2",new SimpleNode());
        Layer pool2 = factory.createLayer(LAYERTYPE.POOL,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\pool2",new MaxNode(new ReLu(),new SimpleOptions()));
        Layer cov3 = factory.createLayer(LAYERTYPE.CONVOLUTION,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\cov3",new SimpleNode());
        Layer fullCon1 = factory.createLayer(LAYERTYPE.GENERAL,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\full1",new SimpleNode());
        Layer fullCon2 = factory.createLayer(LAYERTYPE.GENERAL,"C:\\CodeGang\\Projects\\NN\\src\\main\\resources\\full2",new SimpleNode(new SimpleFunction(),new SimpleOptions()));
        Layer dropOut = factory.createLayer(LAYERTYPE.DROPOUT,"",new SimpleNode());
        //建立网络结构
        network.add(cov1);
        network.add(pool1);
        network.add(cov2);
